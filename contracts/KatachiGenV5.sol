...
contract KatachiGenV5 is ERC721Enumerable, ERC721Burnable, Ownable2Step, ReentrancyGuard, AccessControl {
    ...
    // Minter-controlled mint with URI (for server-side minting flow)
    function minterMint(address to, string memory uri) external onlyRole(MINTER_ROLE) {
    ...
    // Required override for Ownable2Step - sync AccessControl roles on ownership transfer
